...
function PhotoRefresher() {
	...
	$(document).on("backgroundUpdated.veload",function(){
		...
		var newCol = domCol.tint(80).setAlpha(.9);
		var darkCol = domCol.shade(30).saturate(30);
		var darkerCol = darkCol.shade(60).saturate(70).brighten(10);
		var readable = mostReadable(newCol,["#fff","#000",domCol,darkCol])
